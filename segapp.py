...
if not os.path.isfile('fmodel.h5'):
    subprocess.run(['wget','-O', 'fmodel.h5','https://drive.google.com/file/d/1Lx9rVKdBtKVC2Iu0jyBCm2V4ol0FJ9iw/view?usp=share_link'])
if not os.path.isfile('bmodel.h5'):
    subprocess.run(['wget', '-O', 'bmodel.h5' ,'https://drive.google.com/file/d/1WUoZ4f18ssh8v1CK5ItxMmnvZ8chi-Ln/view?usp=share_link'])
# if not os.path.isfile('fmodel.h5'):
